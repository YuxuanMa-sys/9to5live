        ...
        {[
          {
            data: [
              ...
              ["Date & Time", "Dec 23, 2024 | 10:00 AM"],
          ...
          >
            {section.data.map(([label, value], index) => (
              <View key={index} style={styles.viewContainer}>
                <Text style={styles.viewLeft}>{label}</Text>
                <Text style={[styles.viewRight, { color: dark ? COLORS.white : COLORS.black }]}>{value}</Text>
              </View>
            ))}
            {section.extra}
          </View>
...
const styles = StyleSheet.create({
  ...
  backIcon: { height: 24, width: 24, tintColor: COLORS.black, marginRight: 16 },
  headerTitle: { fontSize: 24, fontFamily: "bold", color: COLORS.black },
  moreIcon: { width: 24, height: 24, tintColor: COLORS.black },
  scrollView: { backgroundColor: COLORS.tertiaryWhite },
  summaryContainer: { width: SIZES.width - 32, alignItems: "center", padding: 16, marginVertical: 8 },
  viewContainer: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", width: "100%", marginVertical: 12 },
  viewLeft: { fontSize: 12, fontFamily: "regular", color: "gray" },
  viewRight: { fontSize: 14, fontFamily: "medium", color: COLORS.black },
  copyContentContainer: { flexDirection: "row", alignItems: "center" },
  statusBtn: { width: 72, height: 28, alignItems: "center", justifyContent: "center", backgroundColor: COLORS.tansparentPrimary, borderRadius: 6 },
  statusBtnText: { fontSize: 12, fontFamily: "medium", color: COLORS.primary }
});
